...
function CustomerInfo(props) {
    ...
    axios
      ...
      .then((res) => {
        ...
        customers_name.sort((eltA, eltB) => {
          console.log(
            "\nWhich comes first: '" +
              eltA.customer_first_name +
              "' or '" +
              eltB.customer_first_name +
              "'?"
          );
      ...
      subHistory.forEach((sub) => {
        ...
        if (elIndex === -1) {
          ...
          elIndex = tempUniquePlans.findIndex(
            (element) => element.id === sub.purchase_uid
          );
  ...
  const setCurrentCustomer = (cust) => {
    ...
    /* AXIOS CALL HERE */
    console.log(
      "(scc) calling predict_next_billing_date on ",
      cust.customer_uid
    );
    axios
  ...
  const inSearchResults = (arr) => {
    ...
    arr.forEach((arrData) => {
      if (
        arrData !== null &&
        arrData.toUpperCase().includes(searchInput.toUpperCase())
      ) {
        keywordFound = true;
      }
    });
  ...
  const filterCustomers = () => {
    ...
    sortedCustomers.forEach((cust) => {
      ...
      let address;
      if (isInvalid(cust.customer_address) || isInvalid(cust.customer_city)) {
        address = "--";
      } else {
      ...
      let zipcode;
      if (isInvalid(cust.customer_zip)) {
        zipcode = "--";
      } else {
      ...
      // Is phone showing up?
      let phone;
      if (isInvalid(cust.customer_phone_num)) {
        phone = "--";
      } else {
          ...
          >
            ...
            >
              <div className={styles.cellInnerWrapper}>
                <span className={styles.cellContent}>{cust.customer_uid}</span>
              </div>
            </div>
            ...
            >
              <div className={styles.cellInnerWrapper}>
                <span className={styles.cellContent}>{fullname}</span>
              </div>
            </div>
            ...
            >
              <div className={styles.cellInnerWrapper}>
                <span className={styles.cellContent}>{address}</span>
              </div>
            </div>
            ...
            >
              <div className={styles.cellInnerWrapper}>
                <span className={styles.cellContent}>{zipcode}</span>
              </div>
            </div>
            ...
            >
              <div className={styles.cellInnerWrapper}>
                <span className={styles.cellContent}>{phone}</span>
              </div>
            </div>
          </div>
        );
  ...
  const displayMealInfo = (data) => {
    ...
    if (data.meal_uid !== null) {
      mealsForDelivery.push(
        <div
          style={{ display: "inline-flex", width: "100%", height: "55px" }}
          tabIndex="0"
          aria-label={
        ...
        historyTabs.push(
          <div>
            ...
            >
              ...
              <div className={styles.arrowCell}>
                <div
                  ...
                  onClick={() => {
                    ...
                    let index2 = uniquePlanCopy[index1].history.findIndex(
                      (tab) => {
              ...
              <div className={styles.histCellOuterWrapper}>
                <div className={styles.histCellInnerWrapper}>
                  <span className={styles.historyCellContent}>--</span>
                </div>
              </div>
  ...
  return (
    ...
    >
            ...
            >
              ...
              >
                <div className={styles.cellInnerWrapper}>
                  ...
                  {sortMode === SORT_ADDRESS ||
                  sortMode === SORT_ADDRESS_REVERSE ? (
                    <div
                      className={
                        sortMode === SORT_ADDRESS
                          ? styles.sortingArrowDown
      ...
      <div className={styles.containerMeals}>
        <div className={styles.sectionHeader}>All Meal Plans</div>
      ...
      {customerDropdown === false ? (
        ...
        >
          <div className={styles.containerHistory}>
            <div className={styles.sectionHeader}>Meal Plan History</div>
            ...
            >
              ...
              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Payment ID</span>
                </div>
              </div>
              ...
              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Payment Type</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Addon</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Subtotal</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Discount</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Service Fee</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Delivery Fee</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Driver Tip</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Taxes</span>
                </div>
              </div>
              ...
              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Amount Paid</span>
                </div>
              </div>

              <div className={styles.planCellOuterWrapper}>
                <div className={styles.planCellInnerWrapper}>
                  <span className={styles.orangeCellContent}>Amount Due</span>
                </div>
              </div>
            </div>
