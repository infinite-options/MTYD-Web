...
const EditPlan = (props) => {
        ...
        .then((res) => {
          ...
          //   .put('http://localhost:2000/api/v2/cancel_purchase', {
            ...
            .then((response) => {
              ...
              props.refreshPlans(profileInfo.customer_uid);
  ...
  useEffect(() => {
    ...
    //     .split("=")[1];
    let customer_uid = props.currentPlan.pur_customer_uid;
  ...
  useEffect(() => {
    if(dataFetched === true){
      ...
      pnbd_data.forEach((sub, index) => {
        ...
        if(props.currentPlan.purchase_uid === sub.purchase_uid){
  ...
  useEffect(() => {
    if(subscriptions !== null) {
      ...
      setDataLoaded(true);
      // console.log("currentPlan before sccpu: ", currentPlan);
      // if(props.defaultDelete){showConfirmCancelPopUp()}
    }
  }, [subscriptions])
