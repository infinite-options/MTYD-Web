      ...
      {(() => {
        if (this.state.windowWidth >= 800) {
          ...
          <div className = {styles.gridDisplayCenter}>
            ...
            <div style = {{display: 'inline-flex', justifyContent: 'space-between'}}>
              ...
              {/*<HomeLink text = "Explore Delivery Options" onClick={() => this.togglePopSignup}/>*/}
              <AddressLink text = "Explore Delivery Options" popSignup={this.togglePopSignup}/>
            </div>   
        ...
        {(() => {
          if (this.state.windowWidth >= 800) {
            return (
        <div style = {{display: 'inline-flex', width: '100%', marginTop: '20px'}}>
          <h3 style = {{textAlign: 'left', fontWeight: 'bold', marginLeft: '5%'}}>UPCOMING MENU</h3>
        </div>
            );
          } else {
            return (
        <div style = {{display: 'inline-flex', width: '100%', marginTop: '20px', justifyContent: 'center'}}>
          <h3 style = {{fontWeight: 'bold'}}>UPCOMING MENU</h3>
        </div>
            );
          }
        })()}
        ...
        {(() => {
          if (this.state.windowWidth >= 800) {
            ...
            <div style = {{marginLeft: '50px', marginRight: '50px', marginBottom: '80px'}}>
              <AddressLink text = "Enter Your Address" popSignup={this.togglePopSignup}/>
            </div>
            </div>
            );
          } else {
